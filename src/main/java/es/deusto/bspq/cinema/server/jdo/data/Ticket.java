...
public class Ticket {
	 ...
	 * @param member Member who has bought the ticket
	 * @param session Session related to the ticket
	 * @param seats List of seats bought
	 */
	 ...
	 * @param member Member who bought the ticket
	 */
